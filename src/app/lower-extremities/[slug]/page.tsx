...
export default async function LowerEntryPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  ...
  const description =
    fm.description || entry.description || "Lower Extremities X-ray positioning guide.";
