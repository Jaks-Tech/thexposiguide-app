...
export default async function LowerEntryPage({ params }: { params: { slug: string } }) {
  const { slug } = params;
  ...
  const description = fm.description || entry.description || "Lower Extremities X-ray positioning guide.";
